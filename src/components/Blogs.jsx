  ...
  return (
    <>
      <div className=" bg-[#f7f6e9] relative min-h-screen w-full  pt-1 pb-1">
        ...
        <h1 className="md:text-[13rem] text-[9rem]  interServices text-center  tracking-tight text-[#1e3730] md:mt-20  ">Blogs</h1>
        <div className="flex gap-1 absolute top-0 left-1/2 -translate-x-12 md:translate-y-43 translate-y-16 items-center  justify-center">
